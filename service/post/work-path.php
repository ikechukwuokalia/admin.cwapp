...
if( $params ):
  if( !empty($params['id']) && !$path = (new MultiForm(get_database("CWS", "admin"),'work_paths','id'))->findById($params['id']) ){
            ...
            <div class="grid-5-tablet">
              ...
              <select name="resource_type" id="task-group" required>
                ...
                <optgroup label="Groups">
                  <?php if ($groups = (new MultiForm(get_database("CWS", "data"), "resource_types", "name"))->findAll()) {
