...
$nav_group = "index";
$page_name = "resource-types";
\check_access("READ", "/resource-types", $work_domain,"", true);
// get default API app
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>Resource types | <?php echo get_constant("PRJ_TITLE"); ?></title>
  <meta charset="UTF-8">
...
<body class="theme-asphalt">
  ...
  <input type="hidden" data-setup="page" data-pager="#data-pager" data-container="#resource-type-list" data-search="types" data-handler="lsRcT" data-name="<?php echo $page_name; ?>" data-group="<?php echo $nav_group; ?>">
  ...
  <section id="cwos-content">
    <form id="delete-rctg-form" method="post" action="/app/admin/src/DeleteResourceType.php" data-validate="false" onsubmit="cwos.form.submit(this,checkPost); return false;" >
      <input type="hidden" name="form" value="delete-rctg-form">
      <input type="hidden" name="CSRF_token" value="<?php echo $session->createCSRFtoken("delete-rctg-form");?>">
      ...
      <br class="c-f">
        <div class="grid-10-laptop grid-8-desktop center-laptop">
          <form
            ...
            method="post"
            action="/app/admin/src/GetResourceType.php"
            data-validate="false"
            onsubmit="cwos.form.submit(this, doFetch); return false;"
            >
            <input type="hidden" name="form" value="taskg-query-form">
            <input type="hidden" name="CSRF_token" value="<?php echo $session->createCSRFtoken("taskg-query-form");?>">
        ...
        <div class="sec-div paddn -pall -p20 tbl-wrp">
          ...
          <table data-role="table" class="vertical theme-color asphalt clear-padding">
            ...
            <tbody id="resource-type-list"></tbody>
          </table>
          <div id="data-pager">
          </div>
          <br class="c-f">
    ...
    <div id="actn-btns">
      <div id="actn-btn-wrp">
        <div id="scrl-wrp">
          <button class="theme-button asphalt block" onclick="cwos.faderBox.url('/app/admin/post/resource-type', {callback : 'requery'}, {exitBtn: true});"> <i class="fas fa-plus"></i> New resource type</button>
        </div>
      </div>
