...
$nav_group = "index";
$page_name = "reserved-keywords";
\check_access("READ", "/reserved-keywords", $work_domain,"", true);
// get default API app
?>
<!DOCTYPE html>
<html lang="en">
<head>
  <title>Reserved keywords | <?php echo get_constant("PRJ_TITLE"); ?></title>
  <meta charset="UTF-8">
...
<body class="theme-asphalt">
  ...
  <section id="cwos-content">
    <form id="delete-rkwrd-form" method="post" action="/app/admin/src/DeleteReservedKeyword.php" data-validate="false" onsubmit="cwos.form.submit(this,checkPost); return false;" >
      <input type="hidden" name="form" value="delete-rkwrd-form">
      <input type="hidden" name="CSRF_token" value="<?php echo $session->createCSRFtoken("delete-rkwrd-form");?>">
      ...
      <br class="c-f">
        <div class="grid-10-laptop grid-8-desktop center-laptop">
          <form
            ...
            method="post"
            action="/app/admin/src/GetReservedKeyword.php"
            data-validate="false"
            onsubmit="cwos.form.submit(this, doFetch); return false;"
            >
            <input type="hidden" name="form" value="rsvdkwd-query-form">
            <input type="hidden" name="CSRF_token" value="<?php echo $session->createCSRFtoken("rsvdkwd-query-form");?>">
